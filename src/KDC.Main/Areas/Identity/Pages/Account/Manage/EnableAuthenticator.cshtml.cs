...
namespace KDC.Main.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel(
        ...
        IStringLocalizer<EnableAuthenticatorModel> _localizer
    ) : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            // We don't allow more than one Authenticator per user
        ...
        {
            // TODO: Set title for authenticator app
            return string.Format(
                CultureInfo.InvariantCulture,
                AuthenticatorUriFormat,
                _urlEncoder.Encode("Kulzer"),
